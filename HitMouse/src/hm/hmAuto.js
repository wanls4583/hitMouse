...
F2xExtend(hm.F2xAuto_29,F2xContainer);
...
F2xExtend(hm.F2xAuto_26,F2xMovieClip);
hm.F2xAuto_26.prototype.initUI=function(){
	var s = this;
	var _d0=new hm.F2xAuto_27();
...
F2xExtend(hm.F2xAuto_27,F2xContainer);
...
F2xExtend(hm.F2xAuto_28,F2xMovieClip);
...
hm.sqwswdwd.prototype.initUI=function(){
	var s = this;
	var _d1=Flash2x.s({type:0,data:"AANBmIAAgBQgWgbgVADQgIgCgcANIgHAWQADgmgEgYIgBgDIgDgTQgEgaghgzQgZgngGgWIA9gRQA0gOAlAAQA0AAA0AZQAaANANANIAAAEIgTAeIgBABIAAABQgtBCgXApIgBABQgWAngPA1QgDgkgFgGg"},{type:0,color:"#EC6535"},null);
	Flash2x.d(_d1,{x:15.375,y:14.425});
	var _d0=Flash2x.s({type:0,data:"AgUBTIg6AsIgBABIgCABIgHgKQgTgYgOg/IAAgCIAAgCIgDgPIgMg9IAAgBIgNhJQgBgGACgGIADgHIACAGQAGAWAZAoQAhAzAEAaIADATIABADQAEAXgDAmIAHgVQAcgOAIACQAVgCAWAbIAAABQAFAGADAjQAPg0AWgoIABgBQAXgmAthFIAAAAIABgBIATgeQgCANAAARIAAADIgFAdQgMA2gaAvQgpBEgpAVQgYgJgTgyg"},{type:0,color:"#BF4D00"},null);
	Flash2x.d(_d0,{x:15.0583,y:16.675});
	s.addChild(_d0);
	s.addChild(_d1);
};
...
hm.F2xAuto_4=function(){
	var s = this;
	F2xContainer.call(s);
	s.initUI();
};
F2xExtend(hm.F2xAuto_4,F2xContainer);
hm.F2xAuto_4.prototype.initUI=function(){
	var s = this;
...
hm.F2xAuto_3=function(){
	var s = this;
	F2xContainer.call(s);
	s.initUI();
};
F2xExtend(hm.F2xAuto_3,F2xContainer);
hm.F2xAuto_3.prototype.initUI=function(){
	var s = this;
	var _d1=Flash2x.s({type:0,data:"AA+geQAaAUgVAPQgUARgSARQgRAQgMgGQgJgHgcgMQgdgKgIgQQgEgGAEgJQAEgJANgKQAZgUAiAAQAkAAAYAUg"},null,{type:0,color:"#663300",lineWidth:3,caps:"round",joints:"round",miter:"10"});
	Flash2x.d(_d1,{x:0.01915,y:0.01685});
	var _d0=Flash2x.s({type:0,data:"AAAAxQgJgHgcgMQgdgKgIgQQgEgGAEgJQAEgJANgKQAZgUAiAAQAkAAAYAUQAaAUgVAPIgmAiQgMAMgKAAQgDAAgEgCg"},{type:0,color:"#663300"},null);
...
hm.F2xAuto_30.prototype.initUI=function(){
	var s = this;
	var _d2=Flash2x.s({type:0,data:"AA/gBQAAASgOAOQgPAOgTAAQgSAAgOgOQgOgOAAgSQAAgUAOgOQAOgOASAAQATAAAPAOQAOAOAAAUgACdAAQAAA0geAoQgHAJgJAJQguAvhBAAQhAAAgugvQgugtAAhBQAAhAAuguQAuguBAAAQBBAAAuAuQAuAuAABAg"},null,{type:0,color:"#663300",lineWidth:3,caps:"round",joints:"round",miter:"10"});
...
F2xExtend(hm.F2xAuto_10,F2xContainer);
...
F2xExtend(hm.F2xAuto_9,F2xMovieClip);
...
hm.sqswdedd.prototype.initUI=function(){
	var s = this;
	var _d0=new hm.F2xAuto_32();
	var _d1=new hm.F2xAuto_33();
...
hm.F2xAuto_23=function(){
	var s = this;
	F2xContainer.call(s);
	s.initUI();
};
F2xExtend(hm.F2xAuto_23,F2xContainer);
hm.F2xAuto_23.prototype.initUI=function(){
	var s = this;
	var _d0=Flash2x.b("hm","F2xAuto_39");
	Flash2x.d(_d0,{y:4});
	s.addChild(_d0);
};
...
hm.F2xAuto_0.prototype.initUI=function(){
	var s = this;
	var _d0=Flash2x.b("hm","F2xAuto_36");
